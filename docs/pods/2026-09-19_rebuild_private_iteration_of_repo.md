...
# 🧭 **If you want, I can also re-render:**

- the location of the OBDA files  
- the location of the TTL ontologies  
- the location of the SQL grounding views  
- the location of the drift checker  
- the location of the structural ontology extractor  
- the location of the manifest + graph metadata  
- the location of the mosaic renderer (if present)
